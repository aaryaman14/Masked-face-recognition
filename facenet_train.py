...
from inception_resnet_v1_reduction import inference_reduction as inception_resnet_v1_reduction
...
class Facenet():
    ...
    def model_init(self,para_dict):
        ...
        if infer_method == "simple_resnet":
            ...
            prelogits, _ = inception_resnet_v1_reduction(tf_input, tf_keep_prob,phase_train=tf_phase_train,
...
if __name__ == "__main__":
    train_img_dir = [r"C:\Users\aarya\Downloads\CASIA-WebFace\cropped faces",
                      r"C:\Users\aarya\Downloads\CASIA-WebFace\cropped faces mask"]
    test_img_dir = r"C:\Users\aarya\Downloads\LFW_aligned\detect_aligned"
    ...
    '''
    1. If your Nvidia GPU memory >= 6GB, you can use inception_resnet_v1
    2. If your Nvidia GPU memory < 6GB, you can use inception_resnet_v1_reduction
    2. If your Nvidia GPU memory = 2GB, you can only use inception_resnet_v1_reduction
    '''
    infer_method = "inception_resnet_v1_reduction"#'simple_resnet'#"inception_resnet_v1" #"inception_resnet_v1_reduction"
    loss_method = "cross_entropy"
    opti_method = "adam"
    learning_rate = 5e-4
    save_dir = r"C:\Users\aarya\Downloads\CASIA-WebFace\pb files"
    ...
    '''
    1. If your Nvidia GPU memory >= 6GB, you can set batch_size >= 96
    2. If your Nvidia GPU memory < 6GB, you can set batch_size < 96
    3. If your Nvidia GPU memory = 2GB, you can set batch_size = 16
    '''
    batch_size = 32
    ratio = 0.002#1.0#0.002
